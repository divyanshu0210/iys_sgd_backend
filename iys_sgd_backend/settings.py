...
ACCOUNT_EMAIL_CONFIRMATION_ANONYMOUS_REDIRECT_URL = f"{FRONTEND_BASE_URL}/signin"
...
PASSWORD_RESET_CONFIRM_URL = f"{FRONTEND_BASE_URL}/password-reset-confirm/{{uid}}/{{token}}/"
